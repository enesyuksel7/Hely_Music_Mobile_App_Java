...
import com.example.hely.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        Toast.makeText(this, "Harita Açıldı", Toast.LENGTH_SHORT).show();
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            String MevcutKonum = currentLocation.toString();
                            Toast.makeText(MapsActivity.this, "MEVCUT KONUM PARAMETRELERİ "+MevcutKonum, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MapsActivity.this, "Geçerli Konum Alınamıyor", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
